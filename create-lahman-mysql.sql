...
CREATE TABLE teams (
  ...
  div_ID INT DEFAULT NULL, /* AS FK TO divisions TABLE*/
...
CREATE TABLE teamshalf (
  ...
  lgID char(2) NOT NULL,
  teamID char(3) NOT NULL,
  team_ID INT DEFAULT NULL, /* AS FK TO teams TABLE*/
...
CREATE TABLE allstarfull (
  ID INT NOT NULL AUTO_INCREMENT, /* */
  playerID varchar(9) NOT NULL,
  yearID smallint(6), /*NOTE: Allowing NULL values because ['bailean01', None, None, None, 'OAK', 1512, 'AL', 0, None] has no yearID */
...
CREATE TABLE homegames (
  ...
  team_ID INT DEFAULT NULL, /* AS FK TO teams TABLE*/
  parkkey varchar(255) DEFAULT NULL,
  park_ID INT DEFAULT NULL, /* AS FK TO parks TABLE*/
...
CREATE TABLE seriespost (
  ...
  team_IDwinner INT DEFAULT NULL, /* AS FK TO teams TABLE*/
  teamIDloser varchar(3) DEFAULT NULL,
  team_IDloser INT DEFAULT NULL, /* AS FK TO teams TABLE*/
